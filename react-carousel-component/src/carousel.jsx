    ...
    <div className="container">
      <div className="row">
        <div className="column-fourth arrow-icon align-left">
          <i className="fas fa-angle-left fa-2x backward" onClick={arrowLeft}></i>
        </div>
        <div className="column-half">
          <div className="images">
            {pokedex.map(character => {
              return (
                <img className={currentView === character.id
                  ? 'content'
                  : 'content hidden'}
        ...
        <div className="column-fourth arrow-icon align-right">
          <i className="fas fa-angle-right fa-2x forward" onClick={arrowRight}></i>
        </div>
      </div>
      <div className="row">
        <div className="column-full">
          <div className="progress-icons">
            {pokedex.map(character => {
              return (
                currentView === character.id
                  ? <i key={character.id} id={character.id} onClick={handleIconClick} className="fas fa-circle circle-icon"></i>
                  : <i key={character.id} id={character.id} onClick={handleIconClick} className="far fa-circle circle-icon"></i>
              );
            })}
          </div>
        </div>
