...
const readObj = require('./read.js');
const createObj = require('./create.js');
const updateObj = require('./edit.js');
const deleteObj = require('./delete.js');
...
if (userInput.toLowerCase() === 'read') {
  ...
  console.log('Need to use: read, create, update, or delete.');
}
